<template>
    <div>
        <div class="max-w-4xl flex items-center h-full flex-wrap mx-auto my-32 lg:my-0">
    
	<!--Main Col-->
	<div id="profile" class="min-w-full w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
	

		<div class="p-4 md:p-12 text-center lg:text-left">
			<!-- Image for mobile view-->
			<div class="block  rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" v-bind:style="{backgroundImage: 'url('+actualCompany.item.logo+ ')' }"></div>
    ...
    <div >
            ...
            <div>Amministratori Aziendali</div>
            <div>Mobility Manager</div>
            <div>Campagne associate</div>
    </div>
</template>
<script>

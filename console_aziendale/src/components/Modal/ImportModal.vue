      ...
      <modal>
        ...
        >
          <v-btn
            ...
            color="primary"
          >
            <a v-iy="typeCall == 'location'" href="/files/exampleLocations.csv" download>Scarica file di esempio</a>
            <a v-iy="typeCall == 'employee'" href="/files/exampleEmployee.csv" download>Scarica file di esempio</a>
          </v-btn>
        </v-row>
        <v-row>
          <v-col
